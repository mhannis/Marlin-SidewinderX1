...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  31.01,  31.01 }
    #define DEFAULT_Ki_LIST {   2.59,   2.59 }
    #define DEFAULT_Kd_LIST { 92.89, 92.89 }
  #else
    #define DEFAULT_Kp 31.01
    #define DEFAULT_Ki 2.59
    #define DEFAULT_Kd 92.89
  #endif
#endif // PIDTEMP
 ...
 */
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.121, 80.121, 399.778, 393.269 }
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.121, 80.121, 399.778, 393.269 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -3, 27, -2 }
